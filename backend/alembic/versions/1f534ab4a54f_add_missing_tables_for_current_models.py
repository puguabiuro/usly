...
def upgrade() -> None:
    ...
    op.create_index('ix_user_blocks_blocked_created', 'user_blocks', ['blocked_user_id', 'created_at'], unique=False)
    op.create_index('ix_user_blocks_blocked_user_id', 'user_blocks', ['blocked_user_id'], unique=False)
    op.create_index('ix_user_blocks_blocker_created', 'user_blocks', ['blocker_user_id', 'created_at'], unique=False)
    op.create_index('ix_user_blocks_blocker_user_id', 'user_blocks', ['blocker_user_id'], unique=False)
    op.create_index('ix_user_blocks_created_at', 'user_blocks', ['created_at'], unique=False)
    ...
    op.create_index('ix_event_saves_event_user', 'event_saves', ['event_id', 'user_id'], unique=False)
    ...
    op.create_index('ix_group_invitations_created_at', 'group_invitations', ['created_at'], unique=False)
    op.create_index('ix_group_invitations_group_id', 'group_invitations', ['group_id'], unique=False)
    op.create_index('ix_group_invitations_invitee_status', 'group_invitations', ['invitee_user_id', 'status'], unique=False)
    op.create_index('ix_group_invitations_invitee_user_id', 'group_invitations', ['invitee_user_id'], unique=False)
    op.create_index('ix_group_invitations_inviter_status', 'group_invitations', ['inviter_user_id', 'status'], unique=False)
    op.create_index('ix_group_invitations_inviter_user_id', 'group_invitations', ['inviter_user_id'], unique=False)
    ...
    op.create_index('ix_user_notifications_event_id', 'user_notifications', ['event_id'], unique=False)
    op.create_index('ix_user_notifications_partner_user_id', 'user_notifications', ['partner_user_id'], unique=False)
